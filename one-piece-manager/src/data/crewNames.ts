...
export const CREW_NAMES: CrewNameData = {
  ...
  bountyHunterOrgTypes: [
    ...
    'Reward Seekers',
    'Prize Hunters',
    'Manhunter Organization',
    'Pursuit Specialists',
    'Apprehension Experts',
    'Recovery Services',
  ],
...
export class CrewNameGenerator {
  ...
  static getStatistics(): {
    ...
    return {
      ...
      totalCombinations:
        pirateCrewCombinations + marineBaseCombinations + bountyHunterOrgCombinations,
    }
  }
}
