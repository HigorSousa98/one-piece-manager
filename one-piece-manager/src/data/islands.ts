...
export const ISLANDS: IslandData[] = [
  ...
  {
    names: ['Kuraigana Island', 'Weatheria', 'Kamabakka Kingdom', 'Torino Kingdom'],
    difficulty: 9,
  },
  {
    names: ['Bowin Islands', 'Namakura Island', 'Peachy Island', 'Momoiro Island'],
    difficulty: 10,
  },
  ...
  {
    names: ['Tequila Wolf', 'Karakuri Island', 'Birdie Kingdom', 'Namakura Island'],
    difficulty: 24,
  },
  {
    names: ['God Valley', 'Lodestar Island', 'Risky Red Island', 'Mystoria Island'],
    difficulty: 25,
  },

  // Nível 26-30 (End Game)
  {
    names: ['Beehive Island', 'Pirate Island', 'Navy G-1', 'Revolutionary Army HQ'],
    difficulty: 26,
  },
  { names: ['Mary Geoise', 'Pangaea Castle', 'Red Port', 'Holy Land'], difficulty: 27 },
  {
    names: [
      'Mariejois Underground',
      'Celestial Dragon District',
      'Government Facility',
      'World Noble Area',
    ],
    difficulty: 28,
  },
  {
    names: [
      "Imu's Chamber",
      'Empty Throne Room',
      'National Treasure Vault',
      'Ancient Weapon Facility',
    ],
    difficulty: 29,
  },
  {
    names: ['Laugh Tale', 'Roadstar Island', 'Final Island', 'One Piece Location'],
    difficulty: 30,
  },
]
