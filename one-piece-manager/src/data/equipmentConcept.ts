...
export const EQUIPMENT_CONCEPTS: EquipmentConceptData[] = [
  ...
  // ===== SUPORTE — CULINÁRIA (COOK) =====
  // Classe F-D: Facas de cozinha e utensílios
  {
    name: 'Kitchen Knife',
  ...
  // ===== SUPORTE — ARQUEOLOGIA (ARCHAEOLOGIST) =====
  {
  ...
  },
  {
    ...
    class: 'B',
    rarity: 0.8,
    statsInfluence: { intelligence: 28, skill: 15, defense: 5 },
    requirements: { level: 35, styleCombatId: [4] },
    isStackable: false,
    weight: 0.5,
    unique: false,
  ...
  // ===== SUPORTE — FRANCO-ATIRADOR (SNIPER) =====
  {
    name: 'Spyglass',
  ...
  // ===== SUPORTE — CARPINTEIRO NAVAL (SHIPWRIGHT) =====
  {
